      ...
      <div className={`h-[60vh] md:h-[95vh] mt-[15px] relative ${gradients.homePage}`}>
        ...
        <div className='absolute top-10 flex flex-col justify-center items-center sm:flex-row sm:gap-10'>
          ...
          {/* <div className='top-[10%] md:top-[10%] lg:top-[20%] xl:top-[5%] py-8 px-4 w-[90%] md:w-[30%] lg:w-[30%] flex flex-col justify-center items-center text-white rounded-2xl z-10 '>
            ...
            <button type="button" onclick="window.location.href='/registration'" class="block w-[70%] text-white bg-orange-400 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-[12px] sm:text-sm px-5 py-2.5 text-center mb-1 sm:mb-10 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Registration</button>
          </div> */}
        ...
        <section className="pt-6 w-full">
          <div className=" container mx-auto flex md:px-5 py-2 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 px-6 lg:pr-24 md:pr-16 relative flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              ...
              <h1 className="relative title-font text-4xl md:text-6xl mb-4 font-bold border-b-4 pb-4 px-8 md:px-0 md:pr-24 border-cyan-600"><span className='text-orange-400'>MAC</span>2024
              </h1>
