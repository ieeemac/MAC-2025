...
<span className='text-orange-400'>MAC</span><span className='text-white'>2024</span>
  ...
  <ul tabIndex={0} className="text-white text-[17px] font-semibold menu p-2 shadow bg-stone-800 rounded-xl w-52 flex flex-col items-start">
    ...
    <Link href='/dates'>
    <li className={`${router.pathname == "/dates" ? " hover:border-orange-400 text-orange-400" : ""} hover:bg-orange-300  hover:text-black rounded-lg w-full text-left p-2`}>
    Important Dates
    </li>
    </Link>
    <Link href='/tracks' scroll={false}>
    <li className={`${router.pathname == "/tracks" ? " hover:border-orange-400 text-orange-400" : ""} hover:bg-orange-300  hover:text-black rounded-lg w-full text-left p-2`}>Call For Papers</li>
    </Link>
    ...
    <li className='hover:bg-orange-300  hover:text-black rounded-lg w-full text-left p-2'>Download Schedule</li>
            ...
            <span className={`${router.pathname == "/registration" ? " text-orange-400" : "text-white"}  cursor-pointer w-32 px-4 text-center py-2 hover:font-bold border-b-2 border-black hover:border-b-2 hover:text-orange-400 hover:border-orange-400`}>
            Registration</span>
            </Link>
